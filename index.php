...
<?php
//Chuyển hướng về trang quản trị nếu là admin
if(isset($_POST['btnAdmin']))
{
	header("location:../khoapham.vn/admin/index.php");
}
?>
<?php 
//Đăng xuất
...
<div id="wrap-vp">
	<div id="header-vp">
    	<a alt="logo" href="index.php"><div id="logo"><img src="images/logo.gif" /></div></a>
